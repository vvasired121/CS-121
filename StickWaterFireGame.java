  ...
  // First, get the computer's choice by calling the getRandomChoice() method.
        ...
        */
        if ((playerChoice.equals("W") && computerChoice.equals("F"))
          || (playerChoice.equals("S") && computerChoice.equals("W"))
           || (playerChoice.equals("F") && computerChoice.equals("S"))) {
         
             playerScore++;
             rounds++;
            
        } else if ((playerChoice.equals("F") && computerChoice.equals("W"))
                || (playerChoice.equals("W") && computerChoice.equals("S"))
               || (playerChoice.equals("S") && computerChoice.equals("F"))) {
   ...
   */
   public boolean isValidInput(String inputStr){
     if ((inputStr.equals("S")) || (inputStr.equals("W")) || (inputStr.equals("F")) ||
        (inputStr.equals("s")) || (inputStr.equals("w")) || (inputStr.equals("f"))){
        return true;
    }
     return false;
